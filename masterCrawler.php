<?php
error_reporting(0);
// Dear Professor, this code has been adapted to fit our database needs by Sabeet Chowdhury.
/*
...
function get_details($url) {
	...
	$password = "";
	$dbname = "searchengine";
	$connect = mysqli_connect($server, $username, $password, $dbname) or die('Connection Error');
	...
	$sql ="INSERT INTO page(pageTitle,pageURL,pageDescription)
